                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="home.php">All Products</a></li>
                            <li>
                    ...
                    <button class="btn btn-outline-dark" type="submit">
                        <a href="cart.php"> <i class="bi-cart-fill me-1"></i>
                            ...
                            <span class="badge bg-dark text-white ms-1 rounded-pill">
                                <?php
                                // display total cart product amout
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                /**
                 * display prodduct code is here
                 */
                $prObj = new productController();
                $getproduct = $prObj->getAllProduct();
                if ($getproduct) {
                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <!-- add to cart form with input and button control -->
                                        <form action="" method="post">
                                            <input type="hidden" name="proid" value="<?php echo $result['id']; ?> " />
                                            <input type="number" class="col-4" name="quantity" value="1" />
                                            <button class="btn btn-outline-dark mt-auto" name="addcart">Add to cart</button>
                                    </div>
                                    </form>
