<?php
    ...
    //    echo "register";
       $userReg = $objUser->userRgister($_POST);
    }
?>
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST">
                                <div class="form-group">
                                    <input class="form-control form-control-user" type="text" id="exampleName" placeholder="Your Name" name="name">
                                </div>
                                ...
                                <div class="form-group"><input class="form-control form-control-user" type="text" id="exampleInputPhone" aria-describedby="phoneHelp" placeholder="Phone number" name="phone"></div>
