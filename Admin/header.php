        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>ECOMWEB</span></div>
                </a>
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation">
                           <!-- <a class="nav-link" href="#"><i class="fas fa-table"></i><span>Manage Product</span></a> -->
                    </li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="productlist.php"><i class="fas fa-user"></i><span>View Products</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="addproduct.php"><i class="fas fa-user"></i><span>Add new Product</span></a></li>
