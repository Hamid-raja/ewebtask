...
if (isset($_POST['adminlogin'])) {
    ...
    require ('../Service/adminLogin.php');
    $objAdmin = new adminLogin();
    $adminUser = $_POST['email'];
    $adminPass = md5($_POST['password']);

    $loginChk = $objAdmin->adminLogin($adminUser, $adminPass);
}
                            ...
                            <div class="col-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        </div><button class="btn btn-primary btn-block text-white btn-user" name="adminlogin" type="submit">Login</button>
                                    </form>
